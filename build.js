...
import {
  ...
  buildNoticeBar, noticeState, nextMeetingTile,
...
const noticeHTML   = buildNoticeBar(notice);
...
copyFileSync('./page.js', './dist/page.js');
...
const { active: noticeActive, expired: noticeExpired } = noticeState(notice);
