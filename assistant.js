...
export const ASSISTANT_TOPICS = [
  ...
  { id: 'parking', title: 'Parking or storage waiting list',
    keywords: ['parking','spot','car','garage','storage','unit','waitlist','waiting','list','queue','space'],
    body: 'Join the parking or storage waiting list in the Waiting Lists section.',
