...
export const ASSISTANT_TOPICS = [
  ...
  { id: 'watershutdown', title: 'Water or hot water shut down',
    keywords: ['shutdown','shutoff','shut','brown','discolored','cloudy','air','pipes','banging','faucet','faucets','boiler','restored','pressure','line'],
    body: 'During a scheduled shut down, hot water — and on an affected line, all water — is off for the posted window. When it comes back, open faucets slowly and run them until the water is clear.',
    link: '#updates', linkText: 'See the latest notice' },
